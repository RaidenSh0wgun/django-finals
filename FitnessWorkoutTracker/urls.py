...
from WorkoutPlan.views import WorkoutPlanListCreateView, WorkoutPlanDetailView, ProgressReportListCreateView, DistanceListCreateView, LocationListCreateView, CompletedExerciseCreateView, CompletedExerciseListView, ExerciseListCreateView, ExerciseDetailView, LocationDetailView, DistanceDetailView
...
urlpatterns = [
    ...
    path('api/goal-detail/<int:pk>/', GoalDetailView.as_view(), name='goal-detail'),
    path('api/location-detail/<int:pk>/', LocationDetailView.as_view(), name='location-detail'),
    path('api/distance-detail/<int:pk>/', DistanceDetailView.as_view(), name='distance-detail'),
    path('api/exercise-detail/<int:pk>/', ExerciseDetailView.as_view(), name='exercise-detail'),
    ...
    path('api/goals-detail/<int:pk>/', GoalDetailView.as_view(), name='goal-detail'),
    ...
    path('api/workout-plans-details/<int:pk>/', WorkoutPlanDetailView.as_view(), name='workout-plan-detail'),
    path('api/exercises/', ExerciseListCreateView.as_view(), name='exercise-list-create'),
    path('api/exercises-detail/<int:pk>/', ExerciseDetailView.as_view(), name='exercise-detail'),
